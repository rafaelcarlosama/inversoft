  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-blue.png" alt="Logo" height="50"> <b>INVERSOFT</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name="username" placeholder="Nombre Usuario" autocomplete="off" required />
          ...
          <div class="row">
            ...
            <div class="row">
            <div class="col-xs-12">
              <input type="submit" class="btn btn-primary btn-lg btn-block btn-flat" name="rest" value="¿Olvido su Contraseña?" />
            </div><!-- /.col -->
          </div>
        </form>
