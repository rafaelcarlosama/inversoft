...
<html>
  <head>
    ...
    <meta name="author" content="INVERSOFT -- Inventario de Productos Ferreteria" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:20px">INVERSOFT</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="/www.google.com/" target="_blank">Sistemas Web SENA ADSI</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
