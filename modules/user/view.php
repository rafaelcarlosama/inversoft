          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              <tr>
                ...
                <th class="center">Persona Resposable</th>
            ...
            <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn btn-danger btn-sm" 
            href="modules/user/proses.php?act=delete&id=<?php echo $data['id_user'];?>" 
            onclick="return comfirm('Estas seguro de Eliminar<?php echo $data['nombre']; ?> ?');">
