              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="unidad" data-placeholder="-- Seleccionar --" autocomplete="off" required>
                    ...
                    <option value="Herramientas para la fijación">Herramientas para la fijación</option>
                    <option value="Herramientas auxiliares de usos varios">Herramientas auxiliares de usos varios</option>
                    <option value="Construcción">Construcción</option>
                    <option value="Herramientas de medición o trazo">Herramientas de medición o trazo</option>
                    <option value="Herramientas de golpe o percusión">Herramientas de golpe o percusión</option>
                    <option value="Herramientas de montaje">Herramientas de montaje</option>
                  </select>
                </div>
              </div>
...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=medicines"> Producto </a></li>
